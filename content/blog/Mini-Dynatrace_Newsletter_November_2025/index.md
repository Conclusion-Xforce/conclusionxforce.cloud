...
Now it makes sense to remove the outliers (a boxplot would be great
...
The amount of requests per minute seems to have a positive relationship with
...
so the link from the DQL tile does not work yet:
